    ...
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 pb-10">
      ...
      {overview && overview.trim().length > 0 && (
        <div className="relative group">
          ...
          <div className="relative rounded-2xl bg-slate-50 border border-slate-200 p-8 shadow-2xl">
            ...
            <p className="text-lg leading-relaxed text-slate-600 font-light tracking-wide whitespace-pre-line">
              {overview}
            </p>
          </div>
        </div>
      ...
      {keyPoints.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="space-y-3">
            {keyPoints.map((p, i) => (
              <div key={i} className="flex gap-3 p-4 rounded-xl border border-slate-200/60 bg-white/20 hover:border-emerald-500/30 hover:bg-emerald-900/5 transition-all group">
                ...
                <span className="text-base text-slate-600 leading-relaxed group-hover:text-slate-800 transition-colors">{p}</span>
              </div>
            ))}
          </div>
        </div>
      ...
      {sections.length > 0 && (
        <div className="space-y-4">
          ...
          <div className="flex flex-col gap-4">
            {sections.map((s, i) => (
              <div key={i} className="group relative rounded-xl border border-slate-200 bg-white/40 p-5 md:p-6 hover:border-blue-500/30 hover:bg-slate-100 transition-all">
                ...
                <h4 className="text-base md:text-lg font-bold text-slate-700 mb-2 group-hover:text-blue-400 transition-colors flex items-center gap-2">
                  {s.title}
                </h4>
